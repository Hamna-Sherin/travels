...
//       <path d="M14 8a6 6 0 0 0-6-6" stroke="white" strokeWidth="1.8" strokeLinecap="round">
...
//         color: C.textDark, fontFamily: "inherit",
...
// function UTextarea({ error, ...props }) {
//   const [focused, setFocused] = useState(false);
//   return (
//     <textarea
//       {...props}
...
//         color: C.textDark, fontFamily: "inherit",
//         fontSize: "0.9rem", padding: "8px 0",
//         outline: "none", resize: "none", minHeight: "72px",
//         transition: "border-color 0.2s",
//       }}
//       onFocus={() => setFocused(true)}
//       onBlur={() => setFocused(false)}
...
// function USelect({ error, children, ...props }) {
//   const [focused, setFocused] = useState(false);
//   return (
...
//           background: "transparent", border: "none",
//           borderBottom: `1.5px solid ${error ? "#c0392b" : focused ? C.teal : C.inputBorder}`,
//           color: props.value ? C.textDark : C.textMuted,
...
//         color: C.textMuted, fontSize: "0.6rem",
//       }}>▼</span>
//     </div>
//   );
// }
...
//       {children}
//       {error && (
//         <span style={{ fontSize: "0.7rem", color: "#c0392b", marginTop: "4px", fontWeight: 500 }}>
//           {error}
//         </span>
//       )}
//     </div>
...
//     ),
//     label: "Office",
//     value: "Kottakkal, Malappuram\nKerala — 676503",
//   },
//   {
//     icon: (
//       <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//         <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.362 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6.29 6.29l.91-.91a2 2 0 0 1 2.11-.45c.907.338 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
//       </svg>
//     ),
//     label: "Phone & WhatsApp",
//     value: "+91 88 1234 56789",
//     href: "tel:+918812345678",
//   },
//   {
//     icon: (
//       <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
//     ),
//     label: "Email",
//     value: "hello@rafcotravels.com",
//     href: "mailto:hello@rafcotravels.com",
//   },
// ];
...
//       setStatus("success");
//     } catch (err) {
//       if (err?.errors) { setErrors(err.errors); setStatus("idle"); }
...
//       <style>{`
//         @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,700&family=DM+Sans:wght@300;400;500;600&display=swap');
//         .cs-grid { display: grid; grid-template-columns: 1fr 1.5fr; gap: 0; }
//         .cs-formgrid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px 28px; }
//         .cs-full { grid-column: 1 / -1; }
//         input::placeholder, textarea::placeholder { color: #b5b0a8; }
//         select option { background: #fff; color: #1a1a1a; }
//         @media (max-width: 860px) {
//           .cs-grid     { grid-template-columns: 1fr !important; }
//           .cs-left     { border-right: none !important; border-bottom: 1px solid rgba(26,107,94,0.12) !important; padding-bottom: 40px !important; }
//           .cs-right    { padding-top: 40px !important; }
//           .cs-formgrid { grid-template-columns: 1fr !important; }
//         }
//       `}</style>

//       {/* ── Section wrapper ── */}
//       <section id="contact" style={{ background: C.bodyBg, fontFamily: "'DM Sans','Inter',sans-serif" }}>

//         {/* ── Section header band ── */}
//         <div style={{
//           background: C.teal, padding: "56px 80px 52px",
...
//               color: C.gold, display: "block", marginBottom: "12px",
//             }}>
//               Contact Us
//             </span>
//             <h2 style={{
...
//             }}>
//               Plan your next{" "}
//               <em style={{ color: C.gold, fontStyle: "italic" }}>great journey</em>
//             </h2>
//           </div>
//           <p style={{
...
//           }}>
//             Our travel experts are ready to craft a personalised Kerala experience just for you.
//           </p>
//         </div>

//         {/* ── Two-col body ── */}
//         <div className="cs-grid" style={{ maxWidth: "1200px", margin: "0 auto" }}>

//           {/* ── LEFT: contact info ── */}
//           <div className="cs-left" style={{
//             padding: "52px 48px 52px 80px",
//             borderRight: `1px solid rgba(26,107,94,0.12)`,
//           }}>

//             {/* Decorative gold rule */}
//             <div style={{ width: "40px", height: "3px", background: C.gold, borderRadius: "2px", marginBottom: "32px" }} />

//             {INFO.map(({ icon, label, value, href }) => (
//               <div key={label} style={{ display: "flex", gap: "14px", marginBottom: "28px", alignItems: "flex-start" }}>
//                 <div style={{
//                   width: "38px", height: "38px", borderRadius: "8px", flexShrink: 0,
//                   background: "rgba(201,168,76,0.1)", border: "1px solid rgba(201,168,76,0.2)",
//                   display: "flex", alignItems: "center", justifyContent: "center",
//                   color: C.gold, marginTop: "2px",
//                 }}>
//                   {icon}
//                 </div>
//                 <div>
...
//                   </span>
//                   {href ? (
//                     <a href={href} style={{ fontSize: "0.9rem", color: C.textDark, textDecoration: "none", lineHeight: 1.6 }}>
//                       {value}
//                     </a>
//                   ) : (
//                     <span style={{ fontSize: "0.9rem", color: C.textDark, lineHeight: 1.6, whiteSpace: "pre-line" }}>
//                       {value}
//                     </span>
//                   )}
//                 </div>
...
//             {/* Hours */}
//             <div style={{ marginTop: "36px", paddingTop: "28px", borderTop: `1px solid rgba(26,107,94,0.1)` }}>
//               <span style={{
//                 fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.2em",
//                 textTransform: "uppercase", color: C.textMuted, display: "block", marginBottom: "12px",
//               }}>
//                 Working Hours
//               </span>
//               {[
...
//                   borderBottom: "1px solid rgba(26,107,94,0.07)",
//                 }}>
//                   <span style={{ color: C.textMid }}>{day}</span>
//                   <span style={{ color: time === "Closed" ? C.textMuted : C.teal, fontWeight: 600 }}>{time}</span>
//                 </div>
//               ))}
//             </div>
...
//           {/* ── RIGHT: Form ── */}
//           <div className="cs-right" style={{ padding: "52px 80px 52px 48px" }}>
...
//                   background: "rgba(26,107,94,0.06)",
//                   display: "flex", alignItems: "center", justifyContent: "center",
//                   margin: "0 auto 20px", fontSize: "1.4rem", color: C.teal,
//                 }}>
//                   ✓
//                 </div>
//                 <h3 style={{
//                   fontFamily: "'Playfair Display','Georgia',serif",
//                   fontSize: "1.6rem", fontWeight: 700, color: C.teal, marginBottom: "10px",
//                 }}>
//                   Enquiry Received!
//                 </h3>
//                 <p style={{ fontSize: "0.9rem", color: C.textMid, lineHeight: 1.75 }}>
//                   Our team will get back to you within <strong>24 hours</strong><br />
//                   with a personalised Kerala trip proposal.
//                 </p>
//                 <button
//                   onClick={() => { setStatus("idle"); setForm({ firstName:"",lastName:"",email:"",phone:"",destination:"",message:"" }); }}
//                   style={{
//                     marginTop: "24px", padding: "10px 24px",
//                     borderRadius: "6px", border: `1px solid ${C.teal}`,
...
//                   Send us an enquiry
//                 </p>
//                 <p style={{ fontSize: "0.82rem", color: C.textMuted, marginBottom: "32px", lineHeight: 1.6 }}>
//                   Fill in the details below and we'll plan the perfect itinerary for you.
//                 </p>
...
//                     <Field label="First Name" error={errors.firstName}>
//                       <UInput value={form.firstName} onChange={set("firstName")} placeholder="First name" error={errors.firstName} />
//                     </Field>

//                     <Field label="Last Name" error={errors.lastName}>
//                       <UInput value={form.lastName} onChange={set("lastName")} placeholder="Last name" error={errors.lastName} />
//                     </Field>

//                     <Field label="Email Address" error={errors.email}>
//                       <UInput type="email" value={form.email} onChange={set("email")} placeholder="you@email.com" error={errors.email} />
//                     </Field>

//                     <Field label="Phone / WhatsApp" error={errors.phone}>
//                       <UInput type="tel" value={form.phone} onChange={set("phone")} placeholder="+91 00000 00000" error={errors.phone} />
//                     </Field>

//                     <Field label="Destination" error={errors.destination} style={{ gridColumn: "1 / -1" }}>
//                       <USelect value={form.destination} onChange={set("destination")} error={errors.destination}>
//                         <option value="" disabled>Select a destination</option>
//                         {["Munnar","Alleppey (Backwaters)","Wayanad","Thekkady","Kovalam & Varkala","Kochi","Complete Kerala Tour","Other / Not sure yet"].map(d => (
//                           <option key={d}>{d}</option>
//                         ))}
...
//                   {status === "error" && (
//                     <p style={{ fontSize: "0.8rem", color: "#c0392b", margin: "0 0 14px" }}>
...
//                       background: hoverBtn && status !== "loading" ? C.goldDark : C.gold,
...
// /* ─────────────────────────────────────────────────────────────
//    ContactSection.jsx  — Homepage section, form-only layout
//    Usage: <ContactSection /> just before your <Footer />
// ───────────────────────────────────────────────────────────── */
...
//       <style>{`
//         @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,700&family=DM+Sans:wght@300;400;500;600&display=swap');
//         .cs-grid { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 28px 48px; }
//         input::placeholder, textarea::placeholder { color: #b5b0a8; }
//         select option { background: #fff; color: #1a1a1a; }
//         @media (max-width: 680px) {
//           .cs-header { padding: 44px 24px 40px !important; }
//           .cs-body   { padding: 40px 24px 56px !important; }
//           .cs-grid   { grid-template-columns: 1fr !important; }
//         }
//         @media (min-width: 681px) and (max-width: 1020px) {
//           .cs-header { padding: 44px 40px 40px !important; }
//           .cs-body   { padding: 44px 40px 60px !important; }
...
//             margin: 0, lineHeight: 1.75, fontWeight: 300,
//           }}>
//             Our travel experts will help you craft your perfect trip.
//           </p>
//         </div>
...
//         {/* ── Form body ── */}
//         <div className="cs-body" style={{ padding: "52px 80px 64px" }}>
...
//                 width: "60px", height: "60px", borderRadius: "50%",
//                 border: `2px solid ${C.teal}`,
//                 background: "rgba(26,107,94,0.07)",
//                 display: "flex", alignItems: "center", justifyContent: "center",
//                 margin: "0 auto 20px", fontSize: "1.4rem", color: C.teal,
//               }}>✓</div>
//               <h3 style={{
...
//                 Enquiry Received!
//               </h3>
//               <p style={{ fontSize: "0.9rem", color: C.textMid, lineHeight: 1.75, marginBottom: "24px" }}>
//                 Our team will get back to you within <strong>24 hours</strong> with a personalised Kerala trip proposal.
//               </p>
//               <button
//                 onClick={() => {
//                   setStatus("idle");
//                   setForm({ firstName: "", lastName: "", email: "", phone: "", destination: "", message: "" });
//                 }}
//                 style={{
...
//                 <Field label="First Name" error={errors.firstName}>
//                   <UInput value={form.firstName} onChange={set("firstName")}
//                     placeholder="First name" error={errors.firstName} />
//                 </Field>

//                 <Field label="Last Name" error={errors.lastName}>
//                   <UInput value={form.lastName} onChange={set("lastName")}
//                     placeholder="Last name" error={errors.lastName} />
//                 </Field>

//                 <Field label="Destination" error={errors.destination}>
//                   <USelect value={form.destination} onChange={set("destination")} error={errors.destination}>
//                     <option value="" disabled>Select destination</option>
//                     {["Munnar", "Alleppey (Backwaters)", "Wayanad", "Thekkady",
//                       "Kovalam & Varkala", "Kochi", "Complete Kerala Tour", "Other / Not sure"].map(d => (
//                         <option key={d}>{d}</option>
//                       ))}
//                   </USelect>
//                 </Field>
...
//                 <Field label="Email Address" error={errors.email}>
//                   <UInput type="email" value={form.email} onChange={set("email")}
//                     placeholder="you@email.com" error={errors.email} />
//                 </Field>

//                 <Field label="Phone / WhatsApp" error={errors.phone}>
//                   <UInput type="tel" value={form.phone} onChange={set("phone")}
//                     placeholder="+91 00000 00000" error={errors.phone} />
//                 </Field>

//                 <Field label="Message" error={errors.message}>
//                   <UTextarea value={form.message} onChange={set("message")}
//                     placeholder="Dates, group size, special requests…"
//                     error={errors.message} />
//                 </Field>
...
//               {status === "error" && (
//                 <p style={{ fontSize: "0.8rem", color: "#c0392b", margin: "16px 0 0", textAlign: "center" }}>
//                   Something went wrong. Please try again or WhatsApp us directly.
//                 </p>
//               )}
...
/* ─────────────────────────────────────────────────────────────
   ContactSection.jsx  — Uses React Bootstrap Form components
   Install: npm install react-bootstrap bootstrap
   In main.jsx / index.js add: import 'bootstrap/dist/css/bootstrap.min.css';
───────────────────────────────────────────────────────────── */
  ...
  return (
    <>
      <style>{`
        ...
        /* ── Section fonts ── */
        #contact { font-family: 'DM Sans', 'Inter', sans-serif; background: ${C.bodyBg}; }

        /* ── Override Bootstrap form-control to use underline style ── */
        #contact .form-control,
        #contact .form-select {
          background: transparent !important;
          border: none !important;
          border-bottom: 1.5px solid ${C.inputBorder} !important;
        ...
        #contact textarea::placeholder { color: #b5b0a8; }
        #contact .form-select option   { background: #fff; color: #b5b0a8;}
        ...
        /* ── Textarea no resize ── */
        #contact textarea.form-control { resize: none !important; }
        ...
        #contact .btn-enquiry:hover:not(:disabled) { background: ${C.goldDark}; }
        #contact .btn-enquiry:disabled             { opacity: 0.7; cursor: not-allowed; }
        #contact .btn-enquiry:focus                { box-shadow: none; }
        ...
        #contact .btn-reset:hover  { background: ${C.teal}; color: ${C.white}; }
        #contact .btn-reset:focus  { box-shadow: none; }
      ...
      <section id="contact">
        ...
        {/* ── Teal header band ── */}
        <div className="cs-header text-center" style={{ background: C.teal, padding: "30px" }}>
          <span style={{
            fontSize: "0.68rem", fontWeight: 700, letterSpacing: "0.3em",
            textTransform: "uppercase", color: C.gold, display: "block", marginBottom: "12px",
          }}>
            Get In Touch
          </span>
          <h2 style={{
            fontFamily: "'Playfair Display','Georgia',serif",
            fontSize: "clamp(1.9rem, 3.5vw, 2.8rem)",
            fontWeight: 700, color: C.white, margin: "0 0 14px", lineHeight: 1.15,
          }}>
            Plan your next{" "}
            <em style={{ color: C.gold, fontStyle: "italic" }}>great journey</em>
          </h2>
          <p style={{ fontSize: "0.92rem", color: "rgba(255,255,255,0.6)", margin: 0, lineHeight: 1.75, fontWeight: 300 }}>
            Our travel experts will help you craft your perfect trip.
          </p>
        </div>
        ...
        <div className="cs-body" style={{ padding: "52px 80px 64px" }}>
          ...
          {status === "success" ? (
            ...
            <div className="text-center" style={{ padding: "32px 0" }}>
              <div style={{
                width: "60px", height: "60px", borderRadius: "50%",
                border: `2px solid ${C.teal}`, background: "rgba(26,107,94,0.07)",
                display: "flex", alignItems: "center", justifyContent: "center",
                margin: "0 auto 20px", fontSize: "1.4rem", color: C.teal,
              }}>✓</div>
              <h3 style={{
                fontFamily: "'Playfair Display','Georgia',serif",
                fontSize: "1.7rem", fontWeight: 700, color: C.teal, marginBottom: "10px",
              }}>
                Enquiry Received!
              </h3>
              <p style={{ fontSize: "0.9rem", color: C.textMid, lineHeight: 1.75, marginBottom: "24px" }}>
            ...
            <Form noValidate onSubmit={handleSubmit}>
              <Row className="g-4" style={{ rowGap: "28px", columnGap: "0" }}>
              ...
              {/* Server error */}
              {status === "error" && (
                <p className="text-center mt-3" style={{ fontSize: "0.8rem", color: "#c0392b" }}>
                  Something went wrong. Please try again or WhatsApp us directly.
                </p>
              )}
