...
//                 <h2 className="section-title">Saved Collection</h2>
//                 <hr className="services-divider" />
//             </div>
...
//                         <span className="saved-tab-count">{savedDestinations.length}</span>
//                     )}
//                 </button>
//                 <button
...
//                         <span className="saved-tab-count">{savedPackages.length}</span>
//                     )}
//                 </button>
//             </div>
...
//                             sub="Click the bookmark icon on any destination to save it here."
//                             onBrowse={() => navigate("/")}
//                         />
//                     ) : (
...
export default function Saved() {
  return <CollectionPage type="saved" />;
}